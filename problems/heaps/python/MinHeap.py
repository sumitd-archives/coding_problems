...
class MinHeap:
    ...
    def TopDownHeapify(self, index):
        ...
        child = self.elements[l_child_index].GetValue();
        child_index = l_child_index;
        if r_child_index < self.length:
            r_child_val = self.elements[r_child_index].GetValue();
            if r_child_val < child :
                child = r_child_val;
                child_index = r_child_index;
        if self.elements[index].GetValue() > child:
    ...
    def BottomTopHeapify(self, index):
        ...
        parent_val = self.elements[parent_index].GetValue();
        if self.elements[index].GetValue() < parent_val:
